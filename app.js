...
window.addEventListener('load', ()=>{
    speak("Activating Frost");
    speak("Going online");
    speak("I'm a Virtual Assistant how can i help you");
    wishMe();
})
...
function speakThis(message) {
    ...
    if(message.includes('hey') || message.includes('hello')) {
        ...
        const finalText = "My name is Frost";
        speech.text = finalText;
    }
    ...
    else if(message.includes('play song') || message.includes('play video') || message.includes('search on youtube')) {
